const P20 = "/images/page20";

const badges = [
  { num: "01", label: "基础style", left: "4.58%", top: "14.35%" },
  { num: "02", label: "基础组件", left: "38.75%", top: "14.35%" },
  { num: "03", label: "父级组件", left: "39.24%", top: "64.44%" },
];
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden bg-white">
        ...
        <img src={`${P20}/bg-outer.png`} alt="" className="absolute inset-0 h-full w-full object-cover" />
      </div>

      {/* ── Header ───────────────────────────────────────────────── */}
      <div className="absolute z-10" style={{ left: "4.17%", top: "1.48%", width: "91.67%", height: "3.33%" }}>
        <img src={`${P20}/title.svg`} alt="万相星链" className="absolute left-0 top-0 h-full object-contain" />
        <div className="absolute right-0 top-0 flex h-full items-center gap-[calc(0.7 * var(--u))]">
          <img src={`${P20}/avatar.png`} alt="" className="h-full aspect-square object-cover" />
      ...
      >
        为星链平台打造一套未来开源AI大模型设计系统LanguageGUI
      </p>
      ...
      {badges.map((badge) => (
        <div
          ...
          style={{
            ...
            padding: "clamp(4px, calc(0.56 * var(--u)), 8px)",
            background: "#FFFFFF",
            borderRadius: "60px",
        ...
        >
          <div
            ...
            style={{
              width: "clamp(16px, calc(1.67 * var(--u)), 24px)",
              height: "clamp(16px, calc(1.67 * var(--u)), 24px)",
              background: "#D1FB39",
          ...
          <span style={{ color: "#1F1F1F", fontSize: "clamp(10px, calc(0.97 * var(--u)), 14px)", fontFamily: "'Alimama ShuHeiTi', sans-serif", fontWeight: 700, lineHeight: 1.7, whiteSpace: "nowrap" }}>
            {badge.label}
          </span>
        </div>
      ))}
      ...
      >
        {/* Left panel (colors/fonts/radius) */}
        <img
          src={`${P20}/left-panel.png`}
          alt=""
          className="absolute"
          style={{
            left: 0,
