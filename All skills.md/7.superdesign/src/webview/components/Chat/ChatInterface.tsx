                            ...
                            if (messageText.startsWith('Context: ') && messageText.includes('\n\nMessage: ')) {
                                ...
                                if (contextMatch) {
                                    ...
                                    if (contextFile.includes(', ')) {
                                        ...
                                        displayFileName = contextFile.includes('7.superdesign') 
                                            ? contextFile.split('7.superdesign/')[1] || contextFile.split('/').pop() || contextFile
                            ...
                            <div className="context-display">
                                ...
                                <span className="context-text">
                                    ...
                                    {currentContext.type === 'images' ? 
                                        ...
                                        (currentContext.fileName.includes('7.superdesign') 
                                            ? currentContext.fileName.split('7.superdesign/')[1] || currentContext.fileName.split('/').pop() || currentContext.fileName
