...
- PingFang SC with positive letter-spacing (0.14–0.18px) for body — airy readability
...
- **Body / UI**: `PingFang SC`, fallback: `PingFang SC Fallback`
...
| Body Large | PingFang SC | 20px (1.25rem) | 400 | 1.35 | normal | Introductions |
| Body | PingFang SC | 18px (1.13rem) | 400 | 1.44–1.60 | 0.18px | Standard reading text |
| Body Standard | PingFang SC | 16px (1.00rem) | 400 | 1.50 | 0.16px | UI text |
| Body Medium | PingFang SC | 16px (1.00rem) | 500 | 1.50 | 0.16px | Emphasized body |
| Nav / UI | PingFang SC | 15px (0.94rem) | 500 | 1.33–1.47 | 0.15px | Navigation links |
| Button | PingFang SC | 15px (0.94rem) | 500 | 1.47 | normal | Button labels |
| Button Uppercase | WaldenburgFH | 14px (0.88rem) | 700 | 1.10 (tight) | 0.7px | `text-transform: uppercase` |
| Caption | PingFang SC | 14px (0.88rem) | 400–500 | 1.43–1.50 | 0.14px | Metadata |
| Small | PingFang SC | 13px (0.81rem) | 500 | 1.38 | normal | Tags, badges |
| Code | Geist Mono | 13px (0.81rem) | 400 | 1.85 (relaxed) | normal | Code blocks |
| Micro | PingFang SC | 12px (0.75rem) | 500 | 1.33 | normal | Tiny labels |
| Tiny | PingFang SC | 10px (0.63rem) | 400 | 1.60 (relaxed) | normal | Fine print |
...
- **Positive letter-spacing on body**: PingFang SC uses +0.14px to +0.18px tracking across body text, creating an airy, well-spaced reading rhythm that contrasts with the tight display tracking (-0.96px).
...
- PingFang SC 15px weight 500 for nav links
...
- Apply positive letter-spacing (+0.14px to +0.18px) on PingFang SC body text
...
- Don't apply negative letter-spacing to body text — PingFang SC uses positive tracking
...
- "Design a card: white background, 20px radius. Shadow: rgba(0,0,0,0.06) 0px 0px 0px 1px, rgba(0,0,0,0.04) 0px 1px 2px, rgba(0,0,0,0.04) 0px 2px 4px. Title at 32px Waldenburg weight 300, body at 16px PingFang SC weight 400 letter-spacing 0.16px, #4e4e4e."
- "Build a white pill button: white bg, 9999px radius. Shadow: rgba(0,0,0,0.4) 0px 0px 1px, rgba(0,0,0,0.04) 0px 4px 4px. Text at 15px PingFang SC weight 500."
- "Create an uppercase CTA label: 14px WaldenburgFH weight 700, text-transform uppercase, letter-spacing 0.7px."
- "Design navigation: white sticky header. PingFang SC 15px weight 500. Black pill CTA right-aligned. Border-bottom: rgba(0,0,0,0.05)."
...
4. Positive letter-spacing on PingFang SC body (+0.14px to +0.18px) — the airy reading quality
