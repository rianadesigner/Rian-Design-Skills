...
const captionStyle = {
  box: {
    ...
    alignItems: "center",
    padding: "clamp(4px, calc(0.56 * var(--u)), 8px) clamp(8px, calc(0.83 * var(--u)), 12px)",
    ...
    >
      ...
      >
        ...
        <div
          ...
          style={{ left: "2.78%", top: "19.5%", gap: "clamp(3px, calc(0.42 * var(--u)), 6px)" }}
        >
          <div
            className="flex items-center justify-center flex-shrink-0"
            style={{ width: "clamp(14px, calc(1.39 * var(--u)), 20px)", height: "clamp(14px, calc(1.39 * var(--u)), 20px)", background: "#D1FB39", borderRadius: "10px" }}
          >
      ...
      >
        ...
        <div
          className="absolute flex items-center"
          style={{ left: "2.78%", top: "16.67%", gap: "clamp(3px, calc(0.42 * var(--u)), 6px)" }}
        >
          <div
            className="flex items-center justify-center flex-shrink-0"
            style={{ width: "clamp(14px, calc(1.39 * var(--u)), 20px)", height: "clamp(14px, calc(1.39 * var(--u)), 20px)", background: "#D1FB39", borderRadius: "10px" }}
        ...
        <div
          className="absolute flex items-center"
          style={{ left: "47.15%", top: "2%", gap: "clamp(3px, calc(0.42 * var(--u)), 6px)" }}
        >
          <div
            className="flex items-center justify-center flex-shrink-0"
            style={{ width: "clamp(14px, calc(1.39 * var(--u)), 20px)", height: "clamp(14px, calc(1.39 * var(--u)), 20px)", background: "#D1FB39", borderRadius: "10px" }}
        ...
        >
          <span style={{ color: "#FFFFFF", fontSize: "clamp(9px, calc(0.83 * var(--u)), 12px)", fontFamily: "'PingFang SC', sans-serif", lineHeight: 1.7 }}>
            ONEBP平台_组件视角
          </span>
          <p style={{ color: "#FFFFFF", fontSize: "clamp(8px, calc(0.76 * var(--u)), 11px)", fontFamily: "'PingFang SC', sans-serif", lineHeight: 1.7, margin: 0 }}>
      ...
      <div className="absolute z-20" style={{ left: "4.17%", top: "1.48%", width: "91.67%", height: "3.33%" }}>
        ...
        <div className="absolute right-0 top-0 flex h-full items-center gap-[calc(0.7 * var(--u))]">
          <p style={{ color: "#FFFFFF", fontSize: "20px", fontFamily: "'标小智无界黑', 'LogoSC Unbounded Sans', sans-serif", textAlign: "right", lineHeight: 1.4, margin: 0, whiteSpace: "nowrap" }}>
            创意洞察&大外投 / 26
          </p>
        </div>
        <div className="absolute" style={{ left: "6.5%", top: "-2.6%" }}>
          <div style={{ border: "1px solid #FFFFFF", padding: "calc(0.3 * var(--u)) calc(0.8 * var(--u))", transform: "rotate(-1deg)" }}>
            <p style={{ color: "#FFFFFF", fontFamily: "'LogoSC Unbounded Sans', sans-serif", fontSize: "clamp(10px, calc(1.1 * var(--u)), 16px)", lineHeight: 1.4, margin: 0 }}>
              2021 / 2022
            </p>
          </div>
        </div>
