...
What distinguishes Revolut is its pill-everything button system. Every button uses 9999px radius — primary dark (`#191c1f`), secondary light (`#f4f4f4`), outlined (`transparent + 2px solid`), and ghost on dark (`rgba(244,244,244,0.1) + 2px solid`). The padding is generous (14px 32px–34px), creating large, confident touch targets. Combined with PingFang SC for body text at various weights and positive letter-spacing (0.16px–0.24px), the result is a design that feels both premium and accessible — banking for the modern era.
...
- PingFang SC for body text with positive letter-spacing (0.16px–0.24px)
...
- **Body / UI**: `PingFang SC` — standard system sans
...
| Body Large | PingFang SC | 18px (1.13rem) | 400 | 1.56 | -0.09px | Introductions |
| Body | PingFang SC | 16px (1.00rem) | 400 | 1.50 | 0.24px | Standard reading |
| Body Semibold | PingFang SC | 16px (1.00rem) | 600 | 1.50 | 0.16px | Emphasized body |
| Body Bold Link | PingFang SC | 16px (1.00rem) | 700 | 1.50 | 0.24px | Bold links |
...
- **Positive tracking on body**: PingFang SC uses +0.16px to +0.24px, creating airy, well-spaced reading text that contrasts with the compressed headings.
...
- Apply positive letter-spacing on PingFang SC body text
