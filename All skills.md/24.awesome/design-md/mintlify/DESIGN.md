...
**Key Characteristics:**
- PingFang SC with tight negative tracking at display sizes (-0.8px to -1.28px) — compressed yet readable
...
### Font Family
- **Primary**: `PingFang SC`, with fallback: `PingFang SC Fallback, system-ui, -apple-system, sans-serif`
...
|------|------|------|--------|-------------|----------------|-------|
| Display Hero | PingFang SC | 64px (4.00rem) | 600 | 1.15 (tight) | -1.28px | Maximum impact, hero headlines |
| Section Heading | PingFang SC | 40px (2.50rem) | 600 | 1.10 (tight) | -0.8px | Feature section titles |
| Sub-heading | PingFang SC | 24px (1.50rem) | 500 | 1.30 (tight) | -0.24px | Card headings, sub-sections |
| Card Title | PingFang SC | 20px (1.25rem) | 600 | 1.30 (tight) | -0.2px | Feature card titles |
| Card Title Light | PingFang SC | 20px (1.25rem) | 500 | 1.30 (tight) | -0.2px | Secondary card headings |
| Body Large | PingFang SC | 18px (1.13rem) | 400 | 1.50 | normal | Hero descriptions, introductions |
| Body | PingFang SC | 16px (1.00rem) | 400 | 1.50 | normal | Standard reading text |
| Body Medium | PingFang SC | 16px (1.00rem) | 500 | 1.50 | normal | Navigation, emphasized text |
| Button | PingFang SC | 15px (0.94rem) | 500 | 1.50 | normal | Button labels |
| Link | PingFang SC | 14px (0.88rem) | 500 | 1.50 | normal | Navigation links, small CTAs |
| Caption | PingFang SC | 14px (0.88rem) | 400–500 | 1.50–1.71 | normal | Metadata, descriptions |
| Label Uppercase | PingFang SC | 13px (0.81rem) | 500 | 1.50 | 0.65px | `text-transform: uppercase`, section labels |
| Small | PingFang SC | 13px (0.81rem) | 400–500 | 1.50 | -0.26px | Small body text |
...
### Principles
- **Tight tracking at display sizes**: PingFang SC at 40–64px uses -0.8px to -1.28px letter-spacing. This compression creates headlines that feel deliberate and space-efficient — documentation headings, not billboard copy.
...
- **Two-font system**: PingFang SC for all human-readable content, Geist Mono exclusively for technical/code contexts. The boundary is strict — no mixing.
...
- Font: PingFang SC 15px weight 500
...
- Links: PingFang SC 14–15px weight 500, `#0d0d0d` text
...
- "Create a hero section on white background with atmospheric green-white gradient wash. Headline at 64px PingFang SC weight 600, line-height 1.15, letter-spacing -1.28px, color #0d0d0d. Subtitle at 18px PingFang SC weight 400, line-height 1.50, color #666666. Dark pill CTA (#0d0d0d, 9999px radius, 8px 24px padding) and ghost pill button (white, 1px solid rgba(0,0,0,0.08), 9999px radius)."
- "Design a card: white background, 1px solid rgba(0,0,0,0.05) border, 16px radius, 24px padding, shadow rgba(0,0,0,0.03) 0px 2px 4px. Title at 20px PingFang SC weight 600, letter-spacing -0.2px. Body at 14px weight 400, #666666."
- "Build a pill badge: #d4fae8 background, #0fa76e text, 9999px radius, 4px 12px padding, 13px PingFang SC weight 500, uppercase."
- "Create navigation: white sticky header with backdrop-filter blur(12px). PingFang SC 15px weight 500 for links, #0d0d0d text. Dark pill CTA 'Get Started' right-aligned, 9999px radius. Bottom border: 1px solid rgba(0,0,0,0.05)."
- "Design a trust section showing company logos in muted gray. Grid layout with 16px radius containers, 1px border at 5% opacity. Label above: 'Loved by your favorite companies' at 13px PingFang SC weight 500, uppercase, tracking 0.65px."
...
6. Geist Mono uppercase for technical labels, PingFang SC for everything else
