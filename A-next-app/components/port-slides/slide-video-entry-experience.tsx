...
const steps = [
  {
    index: "01",
    title: "先看结果",
    body: "欢迎体验页用成片效果建立能力预期。",
    Icon: Sparkles,
  },
  {
    index: "02",
    title: "立即试用",
    body: "用示例素材把第一次成功提前到登录之前。",
    Icon: Upload,
  },
  {
    index: "03",
    title: "自然转化",
    body: "在保存、上传等价值动作发生时承接登录。",
    Icon: CircleUserRound,
  },
  {
    index: "04",
    title: "回来继续",
    body: "老用户直接回到最近任务和个人素材。",
    Icon: RotateCcw,
  },
]
  ...
  return (
    <VideoThinkingFrame>
      ...
      >
        <div
          className="absolute"
          style={{ left: 0, top: 0, width: "66%", height: "100%" }}
        >
          <div
            className="absolute"
            style={{
          ...
          />
          <ScreenCrop
            src="/images/page27/riff-home-logged-out.webp"
            alt="Riff 未登录欢迎与首页"
            style={{ left: "5%", top: "9%", width: "28%", height: "78%" }}
          />
          <ScreenCrop
            src="/images/page34/riff-home-logged-in.webp"
            alt="Riff 已登录首页"
            style={{
              left: "36%",
              top: "3%",
        ...
        <aside
          className="absolute"
          style={{ right: 0, top: 0, width: "31.5%", height: "100%" }}
        >
          <SectionLabel>PROGRESSIVE ONBOARDING</SectionLabel>
          <h2 style={{ margin: "14px 0 0", fontSize: 23, fontWeight: 650 }}>
            把学习成本拆进成功路径
          </h2>
          ...
          <div
            style={{
              ...
              background:
                "linear-gradient(90deg, rgba(137,10,16,.27), transparent)",
            }}
          >
            <div style={{ color: "rgba(255,255,255,.36)", fontSize: 9 }}>
              DESIGN PRINCIPLE
            </div>
            <div
              style={{
