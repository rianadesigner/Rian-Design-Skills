...
- **UI Supplement**: `PingFang SC` — used for specific UI elements. Fallbacks: `PingFang SC Placeholder`
...
| UI Supplement | PingFang SC | 16px | 500 | 1.00 | -0.2px | Specific UI elements |
...
- Mix in additional typefaces beyond the Matter family + PingFang SC supplement
