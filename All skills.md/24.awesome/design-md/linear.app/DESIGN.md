...
The typography system is built entirely on PingFang SC Variable with OpenType features `"cv01"` and `"ss03"` enabled globally, giving the typeface a cleaner, more geometric character. PingFang SC is used at a remarkable range of weights — from 300 (light body) through 510 (medium, Linear's signature weight) to 590 (semibold emphasis). The 510 weight is particularly distinctive: it sits between regular and medium, creating a subtle emphasis that doesn't shout. At display sizes (72px, 64px, 48px), PingFang SC uses aggressive negative letter-spacing (-1.584px to -1.056px), creating compressed, authoritative headlines that feel engineered rather than designed. Berkeley Mono serves as the monospace companion for code and technical labels, with fallbacks to ui-monospace, SF Mono, and Menlo.
...
- PingFang SC Variable with `"cv01", "ss03"` globally — geometric alternates for a cleaner aesthetic
...
### Font Family
- **Primary**: `PingFang SC Variable`, with fallbacks: `SF Pro Display, -apple-system, system-ui, Segoe UI, Roboto, Oxygen, Ubuntu, Cantarell, Open Sans, Helvetica Neue`
...
|------|------|------|--------|-------------|----------------|-------|
| Display XL | PingFang SC Variable | 72px (4.50rem) | 510 | 1.00 (tight) | -1.584px | Hero headlines, maximum impact |
| Display Large | PingFang SC Variable | 64px (4.00rem) | 510 | 1.00 (tight) | -1.408px | Secondary hero text |
| Display | PingFang SC Variable | 48px (3.00rem) | 510 | 1.00 (tight) | -1.056px | Section headlines |
| Heading 1 | PingFang SC Variable | 32px (2.00rem) | 400 | 1.13 (tight) | -0.704px | Major section titles |
| Heading 2 | PingFang SC Variable | 24px (1.50rem) | 400 | 1.33 | -0.288px | Sub-section headings |
| Heading 3 | PingFang SC Variable | 20px (1.25rem) | 590 | 1.33 | -0.24px | Feature titles, card headers |
| Body Large | PingFang SC Variable | 18px (1.13rem) | 400 | 1.60 (relaxed) | -0.165px | Introduction text, feature descriptions |
| Body Emphasis | PingFang SC Variable | 17px (1.06rem) | 590 | 1.60 (relaxed) | normal | Emphasized body, sub-headings in content |
| Body | PingFang SC Variable | 16px (1.00rem) | 400 | 1.50 | normal | Standard reading text |
| Body Medium | PingFang SC Variable | 16px (1.00rem) | 510 | 1.50 | normal | Navigation, labels |
| Body Semibold | PingFang SC Variable | 16px (1.00rem) | 590 | 1.50 | normal | Strong emphasis |
| Small | PingFang SC Variable | 15px (0.94rem) | 400 | 1.60 (relaxed) | -0.165px | Secondary body text |
| Small Medium | PingFang SC Variable | 15px (0.94rem) | 510 | 1.60 (relaxed) | -0.165px | Emphasized small text |
| Small Semibold | PingFang SC Variable | 15px (0.94rem) | 590 | 1.60 (relaxed) | -0.165px | Strong small text |
| Small Light | PingFang SC Variable | 15px (0.94rem) | 300 | 1.47 | -0.165px | De-emphasized body |
| Caption Large | PingFang SC Variable | 14px (0.88rem) | 510–590 | 1.50 | -0.182px | Sub-labels, category headers |
| Caption | PingFang SC Variable | 13px (0.81rem) | 400–510 | 1.50 | -0.13px | Metadata, timestamps |
| Label | PingFang SC Variable | 12px (0.75rem) | 400–590 | 1.40 | normal | Button text, small labels |
| Micro | PingFang SC Variable | 11px (0.69rem) | 510 | 1.40 | normal | Tiny labels |
| Tiny | PingFang SC Variable | 10px (0.63rem) | 400–510 | 1.50 | -0.15px | Overline text, sometimes uppercase |
| Link Large | PingFang SC Variable | 16px (1.00rem) | 400 | 1.50 | normal | Standard links |
| Link Medium | PingFang SC Variable | 15px (0.94rem) | 510 | 2.67 | normal | Spaced navigation links |
| Link Small | PingFang SC Variable | 14px (0.88rem) | 510 | 1.50 | normal | Compact links |
| Link Caption | PingFang SC Variable | 13px (0.81rem) | 400–510 | 1.50 | -0.13px | Footer, metadata links |
...
### Principles
- **510 is the signature weight**: Linear uses PingFang SC Variable's 510 weight (between regular 400 and medium 500) as its default emphasis weight. This creates a subtly bolded feel without the heaviness of traditional medium or semibold.
...
- **OpenType as identity**: `"cv01", "ss03"` aren't decorative — they transform PingFang SC into Linear's distinctive typeface, giving it a more geometric, purposeful character.
...
- Links: PingFang SC Variable 13–14px weight 510, `#d0d6e0` text
...
### Do
- Use PingFang SC Variable with `"cv01", "ss03"` on ALL text — these features are fundamental to Linear's typeface identity
...
- Don't use positive letter-spacing on display text — PingFang SC at large sizes always runs negative
- Don't use visible/opaque borders on dark backgrounds — borders should be whisper-thin semi-transparent white
- Don't skip the OpenType features (`"cv01", "ss03"`) — without them, it's generic PingFang SC, not Linear's PingFang SC
...
- "Create a hero section on `#08090a` background. Headline at 48px PingFang SC Variable weight 510, line-height 1.00, letter-spacing -1.056px, color `#f7f8f8`, font-feature-settings `'cv01', 'ss03'`. Subtitle at 18px weight 400, line-height 1.60, color `#8a8f98`. Brand CTA button (`#5e6ad2`, 6px radius, 8px 16px padding) and ghost button (`rgba(255,255,255,0.02)` bg, `1px solid rgba(255,255,255,0.08)` border, 6px radius)."
- "Design a card on dark background: `rgba(255,255,255,0.02)` background, `1px solid rgba(255,255,255,0.08)` border, 8px radius. Title at 20px PingFang SC Variable weight 590, letter-spacing -0.24px, color `#f7f8f8`. Body at 15px weight 400, color `#8a8f98`, letter-spacing -0.165px."
- "Build a pill badge: transparent background, `#d0d6e0` text, 9999px radius, 0px 10px padding, `1px solid #23252a` border, 12px PingFang SC Variable weight 510."
- "Create navigation: dark sticky header on `#0f1011`. PingFang SC Variable 13px weight 510 for links, `#d0d6e0` text. Brand indigo CTA `#5e6ad2` right-aligned with 6px radius. Bottom border: `1px solid rgba(255,255,255,0.05)`."
- "Design a command palette: `#191a1b` background, `1px solid rgba(255,255,255,0.08)` border, 12px radius, multi-layer shadow stack. Input at 16px PingFang SC Variable weight 400, `#f7f8f8` text. Results list with 13px weight 510 labels in `#d0d6e0` and 12px metadata in `#62666d`."

### Iteration Guide
1. Always set font-feature-settings `"cv01", "ss03"` on all PingFang SC text — this is non-negotiable for Linear's look
...
7. Berkeley Mono for any code or technical content, PingFang SC Variable for everything else
