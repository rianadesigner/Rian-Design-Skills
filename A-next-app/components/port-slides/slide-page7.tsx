    ...
    >
      ...
      <div
        ...
        style={{
          left: "8.33%",
          top: "14.81%",
          width: "clamp(36px, 4.17vw, 60px)",
          height: "clamp(36px, 4.17vw, 60px)",
      ...
      >
        ...
        <div className="flex flex-col" style={{ gap: "clamp(8px, 0.83vw, 12px)" }}>
          <span style={{ color: "#000000", fontSize: "clamp(12px, 1.25vw, 18px)", fontFamily: "'PingFang SC', sans-serif", fontWeight: 500, lineHeight: 1.7 }}>
            · 视觉风格
          </span>
          <span style={{ color: "#434343", fontSize: "clamp(10px, 1.11vw, 16px)", fontFamily: "'PingFang SC', sans-serif", lineHeight: 1.7 }}>
