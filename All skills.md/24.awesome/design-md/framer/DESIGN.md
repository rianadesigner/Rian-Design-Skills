...
- Extensive OpenType feature usage across PingFang SC for refined micro-typography
...
- **Body/UI**: `PingFang SC Variable` / `PingFang SC` — variable sans-serif with extensive OpenType features. Fallbacks: `PingFang SC Placeholder`, `-apple-system`, `system-ui`
...
| Card Title | PingFang SC Variable | 24px | 400 | 1.30 | -0.01px | OpenType: cv01, cv05, cv09, cv11, ss03, ss07 |
| Feature Title | PingFang SC | 22px | 700 | 1.20 | -0.8px | OpenType: cv05 |
| Sub-heading | PingFang SC | 20px | 600 | 1.20 | -0.8px | OpenType: cv01, cv09 |
| Body Large | PingFang SC Variable | 18px | 400 | 1.30 | -0.01px | OpenType: cv01, cv05, cv09, cv11, ss03, ss07 |
| Body | PingFang SC Variable | 15px | 400 | 1.30 | -0.01px | OpenType: cv11 |
| Nav/UI | PingFang SC Variable | 15px | 400 | 1.00 | -0.15px | OpenType: cv06, cv11, dlig, ss03 |
| Body Readable | PingFang SC Framer Regular | 14px | 400 | 1.60 | normal | Long-form body text |
| Caption | PingFang SC Variable | 14px | 400 | 1.40 | normal | OpenType: cv01, cv06, cv09, cv11, ss03, ss07 |
| Label | PingFang SC | 13px | 500 | 1.60 | normal | OpenType: cv06, cv11, ss03 |
| Small Caption | PingFang SC Variable | 12px | 400 | 1.40 | normal | OpenType: cv01, cv06, cv09, cv11, ss03, ss07 |
...
| Micro Uppercase | PingFang SC Variable | 7px | 400 | 1.00 | 0.21px | uppercase transform |
...
- **OpenType maximalism**: PingFang SC is deployed with 6+ OpenType features simultaneously (`cv01`, `cv05`, `cv09`, `cv11`, `ss03`, `ss07`), creating a subtly custom feel even at body sizes
...
- **Nav links**: PingFang SC at 15px, weight 400, white text with subtle hover opacity change
...
- Use extensive OpenType features on PingFang SC text (cv01, cv05, cv09, cv11, ss03, ss07)
...
- "Design a feature card on black background with a 1px Framer Blue ring shadow border (rgba(0,153,255,0.15)), 12px border-radius, white heading in PingFang SC at 22px weight 700, and muted silver (a6a6a6) body text"
- "Build a navigation bar with black background, white PingFang SC text links at 15px, and a frosted pill button (rgba(255,255,255,0.1) background, 40px radius) as the CTA"
...
- "Design a pricing card using pure black surface, Framer Blue (#0099ff) accent for the selected plan border, white text hierarchy (24px PingFang SC bold heading, 14px regular body), and a solid white pill CTA button"
