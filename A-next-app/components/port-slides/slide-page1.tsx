    ...
    >
      ...
      <div className="absolute z-10 flex items-center" style={{ left: "44.1%", top: "10%", gap: "calc(0.75 * var(--u))" }}>
        ...
        <div className="flex items-end">
          ...
          <div className="ml-[calc(0.2 * var(--u))] flex flex-col items-start">
            <div className="flex items-center justify-center" style={{ background: "#D1FB39", borderRadius: "calc(0.83 * var(--u))", padding: "calc(0.12 * var(--u)) calc(0.38 * var(--u))" }}>
              <p style={{ color: "#1a1a1a", fontSize: "clamp(6px, calc(0.56 * var(--u)), 8px)", fontFamily: "'LogoSC Unbounded Sans', sans-serif", margin: 0 }}>DAU</p>
            </div>
        ...
        <div className="flex items-end">
          ...
          <div className="ml-[calc(0.2 * var(--u))] flex flex-col items-start">
            <div className="flex items-center justify-center" style={{ background: "#D1FB39", borderRadius: "calc(0.83 * var(--u))", padding: "calc(0.12 * var(--u)) calc(0.38 * var(--u))" }}>
              <p style={{ color: "#1a1a1a", fontSize: "clamp(6px, calc(0.56 * var(--u)), 8px)", fontFamily: "'LogoSC Unbounded Sans', sans-serif", margin: 0 }}>次留</p>
            </div>
      ...
      <div className="absolute z-10 flex items-center gap-[calc(0.28 * var(--u))]" style={{ right: "4.17%", bottom: "4%", padding: "calc(0.83 * var(--u))", background: "rgba(255,255,255,0.15)", border: "1px solid rgba(255,255,255,0.28)", borderRadius: "calc(3.33 * var(--u))", boxShadow: "0px 2px 8px 0px rgba(0,0,0,0.3)" }}>
        ...
        <span style={{ color: "#0A0A0A", fontSize: "clamp(10px, calc(0.97 * var(--u)), 14px)", fontFamily: "'Alimama ShuHeiTi', sans-serif", fontWeight: 700, lineHeight: 1.5, whiteSpace: "nowrap" }}>
          Web(专业研究场景)
        </span>
      </div>
