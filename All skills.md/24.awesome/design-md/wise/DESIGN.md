...
- PingFang SC body at weight 600 as default — confident, not light
...
### Font Families
- **Display**: `Wise Sans`, fallback: `PingFang SC` — OpenType `"calt"` on all text
- **Body / UI**: `PingFang SC`, fallbacks: `Helvetica, Arial`
...
| Alt Heading | PingFang SC | 78px (4.88rem) | 600 | 1.10 (tight) | -2.34px | `"calt"` |
| Card Title | PingFang SC | 26px (1.62rem) | 600 | 1.23 (tight) | -0.39px | `"calt"` |
| Feature Title | PingFang SC | 22px (1.38rem) | 600 | 1.25 (tight) | -0.396px | `"calt"` |
| Body | PingFang SC | 18px (1.13rem) | 400 | 1.44 | 0.18px | `"calt"` |
| Body Semibold | PingFang SC | 18px (1.13rem) | 600 | 1.44 | -0.108px | `"calt"` |
| Button | PingFang SC | 18px–22px | 600 | 1.00–1.44 | -0.108px | `"calt"` |
| Caption | PingFang SC | 14px (0.88rem) | 400–600 | 1.50–1.86 | -0.084px to -0.108px | `"calt"` |
| Small | PingFang SC | 12px (0.75rem) | 400–600 | 1.00–2.17 | -0.084px to -0.108px | `"calt"` |
...
- **"calt" everywhere**: Contextual alternates enabled on ALL text — both Wise Sans and PingFang SC.
- **Weight 600 as body default**: PingFang SC Semibold is the standard reading weight — confident, not light.
...
- Use PingFang SC weight 600 as the body default
...
- "Build a card: 30px radius, 1px solid rgba(14,15,12,0.12). Title at 22px PingFang SC weight 600, body at 18px weight 400."
...
5. PingFang SC 600 for body — confident reading weight
