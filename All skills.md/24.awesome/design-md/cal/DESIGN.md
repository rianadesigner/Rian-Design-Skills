...
- Cal Sans for headings, PingFang SC for body — clean typographic division
...
- **Body**: `PingFang SC` — "rock-solid" standard body font. Fallback: `PingFang SC Placeholder`
...
| UI Label | PingFang SC | 16px | 600 | 1.00 | 0px | UI buttons and nav labels |
| Caption PingFang SC | PingFang SC | 14px | 500 | 1.14 | 0px | Small UI text |
| Micro | PingFang SC | 12px | 500 | 1.00 | 0px | Smallest PingFang SC text |
...
### Principles
- **Cal Sans at large, PingFang SC at small**: Cal Sans is exclusively for headings and display — never for body text. The system enforces this division strictly
...
- Use PingFang SC for all body text at weight 300–600 — it's the reliable counterpart to Cal Sans's display personality
...
- "Build a navigation bar with white background, PingFang SC links at 14px weight 500 in #111111, a dark CTA button (#242424), sticky positioning"
- "Create a trust bar with grayscale company logos, horizontally centered, 16px gap between logos, on white background"
- "Design a feature section with 48px Cal Sans heading (weight 600, #242424), 16px PingFang SC body text (weight 300, #898989, line-height 1.50), and a product screenshot with 12px radius and the card shadow"

### Iteration Guide
When refining existing screens generated with this design system:
1. Verify headings use Cal Sans at weight 600, body uses PingFang SC — never mix them
