...
- PingFang SC with positive letter-spacing (0.2px) for an airy, readable dark-mode experience
...
### Font Family
- **Primary**: `PingFang SC` — humanist sans-serif, used everywhere. Fallbacks: `PingFang SC Fallback`, system sans-serif
- **System**: `SF Pro Text` — Apple system font for select macOS-native UI elements. Fallbacks: `SF Pro Icons`, `PingFang SC`, `PingFang SC Fallback`
...
- **OpenType everywhere**: `ss03` (stylistic set 3) is enabled globally across PingFang SC, giving the typeface a slightly more geometric, tool-like quality
...
- Enable OpenType features `calt`, `kern`, `liga`, `ss03` on all PingFang SC text
...
- "Create a hero section on #07080a background with 64px PingFang SC heading (weight 600, line-height 1.1), near-white text (#f9f9f9), and a semi-transparent white pill CTA button (hsla(0,0%,100%,0.815), 86px radius, dark text #18191a)"
- "Design a feature card with #101111 background, 1px solid rgba(255,255,255,0.06) border, 16px border-radius, double-ring shadow (rgb(27,28,30) 0px 0px 0px 1px outer), 22px PingFang SC heading, and #9c9c9d body text"
- "Build a navigation bar on dark background (#07080a), PingFang SC links at 16px weight 500 in #9c9c9d, hover to white, and a translucent white pill button at the right end"
- "Create a keyboard shortcut display with key caps using gradient background (#121212→#0d0d0d), 5-layer shadow for physical depth, 4px radius, PingFang SC 12px weight 600 text"
...
4. Confirm PingFang SC has OpenType features `calt`, `kern`, `liga`, `ss03` enabled
