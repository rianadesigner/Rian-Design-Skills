  ...
  return (
    ...
    >
      ...
      <span className="absolute z-10" style={{ left: "35.2%", top: "14.7%" }}>
        <span style={{ color: "#434343", fontSize: "clamp(20px, calc(2.78 * var(--u)), 40px)", fontFamily: "'Alimama ShuZhiTi VF', sans-serif", fontWeight: 700, lineHeight: 1.7, letterSpacing: "calc(0.19 * var(--u))" }}>
          「
        </span>
        <span
          style={{
        ...
        <span style={{ color: "#000000", fontSize: "clamp(20px, calc(2.78 * var(--u)), 40px)", fontFamily: "'Alimama ShuZhiTi VF', sans-serif", fontWeight: 700, lineHeight: 1.7, letterSpacing: "calc(0.19 * var(--u))" }}>
          模型应用
        </span>
        <span style={{ color: "#434343", fontSize: "clamp(20px, calc(2.78 * var(--u)), 40px)", fontFamily: "'Alimama ShuZhiTi VF', sans-serif", fontWeight: 700, lineHeight: 1.7, letterSpacing: "calc(0.19 * var(--u))" }}>
          」
      ...
      <div className="absolute z-10 flex items-center" style={{ left: "44.1%", top: "10%", gap: "calc(0.75 * var(--u))" }}>
        ...
        <div className="flex items-end">
          ...
          <div className="ml-[calc(0.2 * var(--u))] flex flex-col items-start">
            <div className="flex items-center justify-center" style={{ background: "#D1FB39", borderRadius: "calc(0.83 * var(--u))", padding: "calc(0.12 * var(--u)) calc(0.38 * var(--u))" }}>
              <p style={{ color: "#434343", fontSize: "clamp(6px, calc(0.56 * var(--u)), 8px)", fontFamily: "'LogoSC Unbounded Sans', sans-serif", margin: 0 }}>DAU</p>
            </div>
            <span style={{ color: "#434343", fontSize: "clamp(6px, calc(0.69 * var(--u)), 10px)", fontFamily: "'PingFang HK', sans-serif", marginTop: "calc(0.1 * var(--u))" }}>w+</span>
          </div>
        </div>
        {/* 分隔线 */}
        <div style={{ width: "1px", height: "calc(1.8 * var(--u))", background: "#8C8C8C", borderRadius: 1, margin: "0 calc(0.5 * var(--u))" }} />
        {/* 次留 */}
        <div className="flex items-end">
          ...
          <div className="ml-[calc(0.2 * var(--u))] flex flex-col items-start">
            <div className="flex items-center justify-center" style={{ background: "#D1FB39", borderRadius: "calc(0.83 * var(--u))", padding: "calc(0.12 * var(--u)) calc(0.38 * var(--u))" }}>
              <p style={{ color: "#434343", fontSize: "clamp(6px, calc(0.56 * var(--u)), 8px)", fontFamily: "'LogoSC Unbounded Sans', sans-serif", margin: 0 }}>次留</p>
            </div>
            <span style={{ color: "#434343", fontSize: "clamp(6px, calc(0.69 * var(--u)), 10px)", fontFamily: "'PingFang HK', sans-serif", marginTop: "calc(0.1 * var(--u))" }}>%+</span>
          </div>
        </div>
      </div>
        ...
        {[
          ...
          <div key={num} className="flex flex-1 flex-col gap-[1vh]">
            <div className="flex items-center gap-[calc(0.56 * var(--u))]">
              <div className="flex items-center justify-center rounded-full bg-[#434343]" style={{ width: "calc(2.08 * var(--u))", height: "calc(2.08 * var(--u))", minWidth: 20, minHeight: 20 }}>
                <p style={{ color: "#FFFFFF", fontSize: "clamp(8px, calc(0.93 * var(--u)), 13.33px)", fontFamily: "'LogoSC Unbounded Sans', sans-serif", margin: 0 }}>{num}</p>
              </div>
              <p style={{ color: "#1F1F1F", fontSize: "clamp(14px, calc(1.53 * var(--u)), 22px)", fontFamily: "'PingFang SC', sans-serif", fontWeight: 600, lineHeight: 1.7, margin: 0 }}>{title}</p>
            </div>
            <span style={{ color: "#434343", fontSize: "clamp(12px, calc(1.25 * var(--u)), 18px)", fontFamily: "'PingFang SC', sans-serif", lineHeight: 1.7 }}>
              {lines[0]}<br />{lines[1]}
            </span>
          </div>
        ))}
      ...
      {/* ── 底部右侧标签 ─────────────────────────────────────────── */}
      <div className="absolute z-10 flex items-center gap-[calc(0.28 * var(--u))]" style={{ right: "4.17%", bottom: "4%", padding: "calc(0.83 * var(--u))", background: "#FFFFFF", border: "1px solid #F0F3FF", borderRadius: "calc(3.33 * var(--u))", boxShadow: "0px 2px 4px 0px rgba(25,33,61,0.08)" }}>
        <div className="flex items-center justify-center overflow-hidden" style={{ width: "calc(1.67 * var(--u))", height: "calc(1.67 * var(--u))", minWidth: 16, minHeight: 16, background: "#D1FB39", borderRadius: "50%" }}>
        ...
        <span style={{ color: "#434343", fontSize: "clamp(10px, calc(0.97 * var(--u)), 14px)", fontFamily: "'Alimama ShuHeiTi', sans-serif", fontWeight: 700, lineHeight: 1.5, whiteSpace: "nowrap" }}>
          Web(专业研究场景)
        </span>
      </div>

      {/* ── 副标题文字 ───────────────────────────────────────────── */}
      <span className="absolute z-10" style={{ left: "19%", top: "23.2%", color: "#666666", fontSize: "clamp(12px, calc(1.25 * var(--u)), 18px)", fontFamily: "'PingFang SC', sans-serif", lineHeight: 1.7 }}>
