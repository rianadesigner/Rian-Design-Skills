  ...
  return (
    ...
    >
      ...
      <svg
        ...
        style={{ left: "4.17%", top: "13.06%", width: "clamp(84px, 10vw, 148px)", height: "13px", opacity: 0.5 }}
        viewBox="0 0 152 13"
        fill="none"
      ...
      {badges.map((badge) => (
        ...
        >
          ...
          <span style={{ color: "#1F1F1F", fontSize: "clamp(10px, 0.97vw, 14px)", fontFamily: "'Alimama ShuHeiTi', sans-serif", fontWeight: 700, lineHeight: 1.7, whiteSpace: "nowrap" }}>
            {badge.label}
          </span>
        </div>
      ))}
