  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden bg-white">
        ...
        <img src={`${P19}/bg-outer.png`} alt="" className="absolute inset-0 h-full w-full object-cover" />
      </div>

      {/* ── Header ───────────────────────────────────────────────── */}
      <div className="absolute z-10" style={{ left: "4.17%", top: "1.48%", width: "91.67%", height: "3.33%" }}>
        <img src={`${P19}/title.svg`} alt="万相星链" className="absolute left-0 top-0 h-full object-contain" />
        <div className="absolute right-0 top-0 flex h-full items-center gap-[0.7vw]">
          <img src={`${P19}/avatar.png`} alt="" className="h-full aspect-square object-cover" />
      ...
      >
        <div
          ...
          style={{
            height: "22.47%",
            padding: "clamp(12px, 1.39vw, 20px) clamp(16px, 2.08vw, 30px) clamp(10px, 1.11vw, 16px)",
        ...
        >
          ...
          <span style={{ color: "#8C8C8C", fontSize: "clamp(10px, 0.97vw, 14px)", fontFamily: "'PingFang SC', sans-serif", lineHeight: 1.7 }}>
