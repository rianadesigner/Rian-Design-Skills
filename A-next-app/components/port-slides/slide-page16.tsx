        ...
        {cards.map((card, i) => (
          ...
          >
            ...
            <div
              ...
              style={{
                paddingTop: "calc(clamp(10px, calc(1.48 * var(--u)), 16px) + 2px)",
                paddingBottom: "clamp(10px, calc(1.48 * var(--u)), 16px)",
                paddingLeft: "clamp(16px, calc(2.08 * var(--u)), 30px)",
                paddingRight: "clamp(16px, calc(2.08 * var(--u)), 30px)",
