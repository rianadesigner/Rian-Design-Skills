const P8 = "/images/page8";

const tools = [
  {
    num: "01",
    title: "学术搜索：支持外挂不同数据库及prompt配置",
    desc: "简化用户搜索负担，提升rag准确性",
  },
  {
    num: "02",
    title: "一键翻译：支持翻译语言，并提供多模态搜索能力",
    desc: "学术高频使用场景，优化rt速度和多语言模型",
  },
  {
    num: "03",
    title: "高级研究：打造不同物料专家交付的产品能力",
    desc: "多模态报告的全链路开源模型适配及优化",
  },
  {
    num: "04",
    title: "场景写作：提供GUI配置降低描述复杂度",
    desc: "适配多元用户需求的模型写作优化",
  },
];
...
export default function SlidePage8() {
  return (
    <div
    ...
    >
            ...
            <div key={tool.num} className="flex items-start gap-[6px]" style={{ flex: 1 }}>
              <div
                style={{
                  ...
                  borderRadius: "50%",
                  background: "rgba(239,59,70,0.78)",
                  display: "flex",
                  alignItems: "center",
      ...
      >
        ...
        >
          ...
          >
            <img loading="lazy" decoding="async" src={`${P8}/mascot-icon.png`} alt="" className="w-[70%] h-[70%] object-contain" />
          </div>
          <span
            style={{
              color: "#FFFFFF",
          ...
          >
            学术搜索：从搜索词及 RAG 检索库到生成结果及提供文献参考信息。
          </span>
        </div>
        <div
          className="absolute flex"
