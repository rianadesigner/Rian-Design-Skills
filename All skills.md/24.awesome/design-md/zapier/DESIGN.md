...
The typographic system is a deliberate interplay of two distinct personalities. **Degular Display** -- a geometric, wide-set display face -- handles hero-scale headlines at 56-80px with medium weight (500) and extraordinarily tight line-heights (0.90), creating headlines that compress vertically like stacked blocks. **PingFang SC** serves as the workhorse for everything else, from section headings to body text and navigation, with fallbacks to Helvetica and Arial. **GT Alpina**, an elegant thin-weight serif with aggressive negative letter-spacing (-1.6px to -1.92px), makes occasional appearances for softer editorial moments. This three-font system gives Zapier the ability to shift register -- from bold and punchy (Degular) to clean and functional (PingFang SC) to refined and literary (GT Alpina).
...
- PingFang SC as the universal UI font across all functional typography
...
- **Primary**: `PingFang SC`, with fallbacks: `Helvetica, Arial`
...
| Section Heading | PingFang SC | 48px (3.00rem) | 500 | 1.04 (tight) | normal | Major section titles |
...
| Sub-heading LG | PingFang SC | 36px (2.25rem) | 500 | normal | -1px | Large sub-sections |
| Sub-heading | PingFang SC | 32px (2.00rem) | 400 | 1.25 (tight) | normal | Standard sub-sections |
| Sub-heading MD | PingFang SC | 28px (1.75rem) | 500 | normal | normal | Medium sub-headings |
| Card Title | PingFang SC | 24px (1.50rem) | 600 | normal | -0.48px | Card headings |
| Body Large | PingFang SC | 20px (1.25rem) | 400-500 | 1.00-1.20 (tight) | -0.2px | Feature descriptions |
| Body Emphasis | PingFang SC | 18px (1.13rem) | 600 | 1.00 (tight) | normal | Emphasized body text |
| Body | PingFang SC | 16px (1.00rem) | 400-500 | 1.20-1.25 | -0.16px | Standard reading text |
| Body Semibold | PingFang SC | 16px (1.00rem) | 600 | 1.16 (tight) | normal | Strong labels |
| Button | PingFang SC | 16px (1.00rem) | 600 | normal | normal | Standard buttons |
| Button SM | PingFang SC | 14px (0.88rem) | 600 | normal | normal | Small buttons |
| Caption | PingFang SC | 14px (0.88rem) | 500 | 1.25-1.43 | normal | Labels, metadata |
| Caption Upper | PingFang SC | 14px (0.88rem) | 600 | normal | 0.5px | Uppercase section labels |
| Micro | PingFang SC | 12px (0.75rem) | 600 | 0.90-1.33 | 0.5px | Tiny labels, often uppercase |
| Micro SM | PingFang SC | 13px (0.81rem) | 500 | 1.00-1.54 | normal | Small metadata text |

### Principles
- **Three-font system, clear roles**: Degular Display commands attention at hero scale only. PingFang SC handles everything functional. GT Alpina adds editorial warmth sparingly.
...
- **Weight as hierarchy signal**: PingFang SC uses 400 (reading), 500 (navigation/emphasis), 600 (headings/CTAs). Degular uses 500 (display) and 600 (buttons).
...
- Links: PingFang SC 16px weight 500, `#201515` text
...
- PingFang SC weight 500 for app names

**Stat Counter**
- Large display number using PingFang SC 48px weight 500
...
- Use PingFang SC for all functional UI -- navigation, body text, buttons, labels
...
- "Create a hero section on cream background (`#fffefb`). Headline at 56px Degular Display weight 500, line-height 0.90, color `#201515`. Subtitle at 20px PingFang SC weight 400, line-height 1.20, color `#36342e`. Orange CTA button (`#ff4f00`, 4px radius, 8px 16px padding, white text) and dark button (`#201515`, 8px radius, 20px 24px padding, white text)."
- "Design a card: cream background (`#fffefb`), `1px solid #c5c0b1` border, 5px radius. Title at 24px PingFang SC weight 600, letter-spacing -0.48px, `#201515`. Body at 16px weight 400, `#36342e`. No box-shadow."
- "Build a tab navigation: transparent background. PingFang SC 16px weight 500, `#201515` text. Active tab: `box-shadow: rgb(255, 79, 0) 0px -4px 0px 0px inset`. Hover: `box-shadow: rgb(197, 192, 177) 0px -4px 0px 0px inset`. Padding 12px 16px."
- "Create navigation: cream sticky header (`#fffefb`). PingFang SC 16px weight 500 for links, `#201515` text. Orange pill CTA 'Start free with email' right-aligned (`#ff4f00`, 4px radius, 8px 16px padding)."
...
4. Three fonts, strict roles: Degular Display (hero), PingFang SC (UI), GT Alpina (editorial)
