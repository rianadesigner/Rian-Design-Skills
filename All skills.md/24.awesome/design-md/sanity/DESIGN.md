...
*Note: waldenburgNormal is a custom typeface. For external implementations, use PingFang SC or Space Grotesk as the sans substitute (geometric, slightly condensed feel). IBM Plex Mono is available on Google Fonts.*
...
3. **Apply typography**: PingFang SC (or Space Grotesk) with tight letter-spacing on headings, 1.50 line-height on body
