        ...
        try {
            ...
            if (workspaceRoot) {
                ...
                if (!fs.existsSync(superdesignDir)) {
                    ...
                    Logger.info(`Created 7.superdesign directory: ${superdesignDir}`);
                }
...
2. You ALWAYS output design files in '7.superdesign/design_iterations' folder as {design_name}_{n}.html (Where n needs to be unique like table_1.html, table_2.html, etc.) or svg file
...
1. Copy/duplicate existing svg file but name it based on our naming convention in design_ierations folder, and then make edits to the copied svg file (So we can avoid lots of mistakes), like 'original_filename.svg 7.superdesign/design-iterations/new_filename.svg'
