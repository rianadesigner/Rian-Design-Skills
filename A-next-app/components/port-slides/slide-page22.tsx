  ...
  return (
    ...
    >
      ...
      <div className="absolute z-10" style={{ left: "4.17%", top: "1.48%", width: "91.67%", height: "3.33%" }}>
        <img loading="lazy" decoding="async" src={`${P22}/title.svg`} alt="万相星链" className="absolute left-0 top-0 h-full object-contain" />
      ...
      <span
        ...
        style={{
          left: "4.17%",
          top: "9.26%",
          backgroundImage: "linear-gradient(101deg, #5C5CFF 0%, #AE5CFF 100%)",
          backgroundClip: "text",
      ...
      <svg
        className="absolute z-10"
        style={{ left: "4.17%", top: "13.24%", width: "clamp(100px, calc(11.11 * var(--u)), 160px)", height: "13px", opacity: 0.5 }}
        viewBox="0 0 152 13"
        fill="none"
