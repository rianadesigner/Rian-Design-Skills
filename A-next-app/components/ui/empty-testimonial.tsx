      ...
      <div className="space-y-4 text-center">
        ...
        <div className="flex flex-col items-center gap-4 !bg-transparent">
          <a
            ...
            className="group flex items-center gap-3 rounded-full border border-dashed border-muted-foreground/30 bg-background px-6 py-3 transition-all duration-300 hover:border-primary hover:bg-primary/5"
          >
            <div className="flex h-6 w-6 items-center justify-center rounded-full bg-primary text-primary-foreground transition-transform duration-300">
              <HugeiconsIcon icon={Add01Icon} size={16} strokeWidth={3} />
            </div>
            <span className="text-md font-medium text-foreground transition-colors group-hover:text-primary">
              Add Testimonial
            </span>
          </a>
        </div>
...
function Page() {
  return (
    <div className="h-full w-full rounded-xl border border-neutral-200 bg-gradient-to-b from-white to-[#F5F5F7] p-4">
