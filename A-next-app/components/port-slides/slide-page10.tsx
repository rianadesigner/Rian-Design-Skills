const P10 = "/images/page10";

const bubbles = [
  { label: "冷启动", left: "15%", top: "43%" },
  { label: "内容\n解释", left: "32.5%", top: "26.25%" },
  { label: "贡献\n闭环", left: "50%", top: "15%" },
  { label: "内容\n质量", left: "67.5%", top: "26.25%" },
  { label: "信任\n建设", left: "85%", top: "43%" },
];

export default function SlidePage10() {
  return (
    <div
    ...
    >
      ...
      <div className="absolute z-10" style={{ left: "4.17%", top: "9.26%" }}>
        ...
        <svg width="clamp(60px, calc(7.5 * var(--u)), 108px)" height="13" viewBox="0 0 152 13" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ display: "none" }}>
          <defs>
      ...
      >
        <path
          d="M3 6C13 2 23 2 33 6C43 10 53 10 63 6C73 2 83 2 93 6C103 10 113 10 127 6"
          stroke="url(#p10wGrad)"
          strokeWidth="6"
          strokeLinecap="round"
          fill="none"
        />
        <defs>
          <linearGradient id="p10wGrad" x1="0" y1="0" x2="130" y2="0" gradientUnits="userSpaceOnUse">
            <stop offset="0" stopColor="#5C5CFF" />
            <stop offset="1" stopColor="#AE5CFF" />
          </linearGradient>
        </defs>
      </svg>
      ...
      >
        ...
        >
          <img
            ...
            alt=""
            className="absolute"
            style={{ left: "0", top: "0", width: "100%", height: "100%", objectFit: "cover", objectPosition: "center bottom", borderRadius: "9px" }}
          />
        </div>
        <div
          className="flex items-center gap-[4px]"
      ...
      >
        ...
        >
          {/* Arc connecting bubbles */}
          <svg className="absolute" style={{ left: "0", top: "0", width: "100%", height: "100%" }} viewBox="0 0 1000 200" fill="none" preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M50,120 Q500,-60 950,120" stroke="rgba(150,150,255,0.4)" strokeWidth="2" strokeDasharray="6 4" fill="none" />
          </svg>
          {/* Bubble labels */}
          {bubbles.map((b, i) => (
            <div
