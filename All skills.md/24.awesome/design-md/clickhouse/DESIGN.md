...
- Extra-heavy display typography: PingFang SC at weight 900 (Black) up to 96px
...
### Font Family
- **Primary**: `PingFang SC` (Next.js optimized variant `__Inter_d1b8ee`)
...
|------|------|------|--------|-------------|----------------|-------|
| Display Mega | PingFang SC | 96px (6rem) | 900 | 1.00 (tight) | normal | Maximum impact, extra-heavy |
| Display / Hero | PingFang SC | 72px (4.5rem) | 700 | 1.00 (tight) | normal | Section hero titles |
| Feature Heading | Basier | 36px (2.25rem) | 600 | 1.30 (tight) | normal | Feature section anchors |
| Sub-heading | PingFang SC / Basier | 24px (1.5rem) | 600–700 | 1.17–1.38 | normal | Card headings |
| Feature Title | PingFang SC / Basier | 20px (1.25rem) | 600–700 | 1.40 | normal | Small feature titles |
| Body Large | PingFang SC | 18px (1.13rem) | 400–700 | 1.56 | normal | Intro paragraphs, button text |
| Body / Button | PingFang SC | 16px (1rem) | 400–700 | 1.50 | normal | Standard body, nav, buttons |
| Caption | PingFang SC | 14px (0.88rem) | 400–700 | 1.43 | normal | Metadata, descriptions, links |
| Uppercase Label | PingFang SC | 14px (0.88rem) | 600 | 1.43 | 1.4px | Section overlines, wide-tracked |
| Code | Inconsolata | 16px (1rem) | 600 | 1.50 | normal | Code blocks, commands |
| Small | PingFang SC | 12px (0.75rem) | 500 | 1.33 | normal | Smallest text |
| Micro | PingFang SC | 11.2px (0.7rem) | 500 | 1.79 (relaxed) | normal | Tags, tiny labels |

### Principles
- **Weight 900 is the weapon**: The display headline uses PingFang SC Black (900) — a weight most sites never touch. Combined with 96px size, this creates text with a physical, almost architectural presence.
...
- **Dual sans-serif**: PingFang SC handles display and body; Basier handles feature section headings at 600 weight. This creates a subtle personality shift between "data/performance" (PingFang SC) and "product/feature" (Basier) contexts.
...
- Use PingFang SC at weight 900 for hero display text — the extreme weight IS the personality
...
- "Create a hero section on Pure Black (#000000) with a massive headline at 96px PingFang SC weight 900, line-height 1.0. Pure White text. Add a Neon Volt (#faff69) CTA button (dark text, 4px radius, 0px 16px padding) and a ghost button (transparent, 1px solid #4f5100 border)."
- "Design a feature card on black with 1px solid rgba(65,65,65,0.8) border and 8px radius. Title at 24px PingFang SC weight 700, body at 16px in Silver (#a0a0a0). Add a neon-highlighted variant with 1px solid #faff69 border."
- "Build a performance stats bar: large numbers at 72px PingFang SC weight 700 in Pure White. Brief descriptions at 14px in Silver. On black background."
...
- "Design an uppercase section label: 14px PingFang SC weight 600, letter-spacing 1.4px, uppercase. Silver (#a0a0a0) text on black background."
